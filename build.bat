...
echo [2/4] block.dll£¨Ö´ÐÐºËÐÄ£ºblock+vmstate+net+plugins+editor£¬Á´ raylib£©...
set SRC=block.c vmstate.c net.c
for %%f in (plugins\*.c) do set SRC=!SRC! %%f
gcc -shared -O2 -I. !SRC! editor.c -o block.dll -Wl,--export-all-symbols -I%RL%\include -L%RL%\lib -lraylib -lopengl32 -lgdi32 -lwinmm -lws2_32
