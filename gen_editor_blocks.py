...
KEYS = [
    ...
    ('hvf', 3, "BLK_hvf", 18),
    ('cv', 2, "BLK_cv", 108),
    ('cvloop', 6, "BLK_cvloop", 208),
    ('cvbody', 6, "BLK_cvbody", 479),
    ('cvskipdo', 8, "BLK_cvskipdo", 131),
    ('cvdrag', 6, "BLK_cvdrag", 115),
    ('cvcopy', 6, "BLK_cvcopy", 343),
    ('cvfin', 5, "BLK_cvfin", 512),
    ('cvposition', 10, "BLK_cvposition", 330),
    ('cvdragclear', 11, "BLK_cvdragclear", 115),
]
