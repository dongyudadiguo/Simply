/* token="BeginMode2D" -> sha256 -> 00db27ebc1a2177b8d9fddd8c1795cace84cb07f303fbea643762ebcd9886436.dll  （参考 add.c 的插件结构） */
#include <stdint.h>
#include <stddef.h>
...
__declspec(dllexport) void run(void) {
    ...
    Camera2D cam; *B->stk_off -= 24; memcpy(&cam, B->stk + *B->stk_off, 24);
    BeginMode2D(cam);
    B->run_next();
