/* token="CheckCollisionPointRec" -> sha256 -> 8b564340223ac4d40f844b25caf0ee19aa89dcd3c5ccb74587d82e4dd8f4c282.dll  （参考 add.c 的插件结构） */
#include <stdint.h>
#include <stddef.h>
...
__declspec(dllexport) void run(void) {
    ...
    Rectangle r; Vector2 p;
    *B->stk_off -= 16; memcpy(&r, B->stk + *B->stk_off, 16);   /* Rectangle = x,y,width,height */
    *B->stk_off -= 8;  memcpy(&p, B->stk + *B->stk_off, 8);
    push_u32(B, CheckCollisionPointRec(p, r) ? 1 : 0);
    B->run_next();
