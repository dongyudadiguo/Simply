/* token="DrawLine" -> sha256 -> 2964669d39728cefc802b646b8a28884817bd0761290ec0b3404a5ed874462a7.dll  （参考 add.c 的插件结构） */
#include <stdint.h>
#include <stddef.h>
...
__declspec(dllexport) void run(void) {
    ...
    int y2 = (int)pop_u32(B);
    int x2 = (int)pop_u32(B);
    int y1 = (int)pop_u32(B);
    int x1 = (int)pop_u32(B);
