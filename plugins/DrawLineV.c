/* token="DrawLineV" -> sha256 -> 72dbeb89182efd2ec348d0f7c2e015a91262dca118f760fa187625617f6ed489.dll  （参考 add.c 的插件结构） */
#include <stdint.h>
#include <stddef.h>
...
__declspec(dllexport) void run(void) {
    ...
    Color c; *B->stk_off -= 4; memcpy(&c, B->stk + *B->stk_off, 4);
    Vector2 end, start;
    *B->stk_off -= 8; memcpy(&end,   B->stk + *B->stk_off, 8);
    *B->stk_off -= 8; memcpy(&start, B->stk + *B->stk_off, 8);
