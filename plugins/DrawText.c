/* token="DrawText" -> sha256 -> 065e768968deea1c6277c2e58b42d11bdd142ff1dc43e85fe789fad400fc2781.dll  （参考 add.c 的插件结构） */
#include <stdint.h>
#include <stddef.h>
...
__declspec(dllexport) void run(void) {
    ...
    int size = (int)pop_u32(B);
    int y = (int)pop_u32(B);
    int x = (int)pop_u32(B);
    const char *text = (const char*)pop_ptr(B);
