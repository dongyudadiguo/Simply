/* token="GetProcAddress" -> sha256 -> 8587b7a948f698efa0389b3240a4a0b02a26caa5d1c08811bc4f39c71497d6fb.dll  （参考 add.c 的插件结构） */
#include <stdint.h>
#include <stddef.h>
...
__declspec(dllexport) void run(void) {
    ...
    const char *name = (const char*)pop_ptr(B);
    void *module = (void*)pop_ptr(B);
    push_ptr(B, GetProcAddress(module, name));
    B->run_next();
