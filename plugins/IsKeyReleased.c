/* token="IsKeyReleased" -> sha256 -> a25c50616b534801c8f794eebf31131abca34f5fa87bb6a4d66a8af36637ac33.dll  （参考 add.c 的插件结构） */
#include <stdint.h>
#include <stddef.h>
...
__declspec(dllexport) void run(void) {
    ...
    int key = (int)pop_u32(B);
    push_u32(B, IsKeyReleased(key) ? 1 : 0);
    B->run_next();
