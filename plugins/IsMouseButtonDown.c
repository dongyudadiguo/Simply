/* token="IsMouseButtonDown" -> sha256 -> 73c1277a1a9dc8bb7e44d0f1dcc66f0694aba553d82a835940dcccb4402910f8.dll  （参考 add.c 的插件结构） */
#include <stdint.h>
#include <stddef.h>
...
__declspec(dllexport) void run(void) {
    ...
    push_u32(B, IsMouseButtonDown(btn) ? 1 : 0);
    B->run_next();
