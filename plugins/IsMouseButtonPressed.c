/* token="IsMouseButtonPressed" -> sha256 -> 93a6e941deb72b04764c00bfa8fbf35dcb02e5687d2551a14ec22b99327e22da.dll  （参考 add.c 的插件结构） */
#include <stdint.h>
#include <stddef.h>
...
__declspec(dllexport) void run(void) {
    ...
    push_u32(B, IsMouseButtonPressed(btn) ? 1 : 0);
    B->run_next();
