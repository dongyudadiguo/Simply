/* token="IsMouseButtonReleased" -> sha256 -> e5119e80f694414d5f76eb287caeb007d8797e779f9d5a8f18860e66add9952f.dll  （参考 add.c 的插件结构） */
#include <stdint.h>
#include <stddef.h>
...
__declspec(dllexport) void run(void) {
    ...
    int btn = (int)pop_u32(B);
    push_u32(B, IsMouseButtonReleased(btn) ? 1 : 0);
    B->run_next();
