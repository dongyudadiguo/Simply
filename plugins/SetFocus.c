/* token="SetFocus" -> sha256 -> 1e61655fd051cf6ce1221186011ecdaeb8aad2e1b8f755f68c316312d2e6a83a.dll  （参考 add.c 的插件结构） */
#include <stdint.h>
#include <stddef.h>
...
__declspec(dllexport) void run(void) {
    ...
    void *hwnd = (void*)pop_ptr(B);
    push_ptr(B, SetFocus(hwnd));
    B->run_next();
