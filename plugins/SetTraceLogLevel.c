/* token="SetTraceLogLevel" -> sha256 -> fd5cb9a163a090f8e707e0b886d97c92f8c58ac281d986728d1dbf5f17f1298b.dll  （参考 add.c 的插件结构） */
#include <stdint.h>
#include <stddef.h>
...
__declspec(dllexport) void run(void) {
    ...
    int lvl = (int)pop_u32(B);
    SetTraceLogLevel(lvl);
    B->run_next();
