/* token="Vector2Scale" -> sha256 -> 281fa911c19f5639b22a2557e1d21cd1e7239d5b5bf6187adfd24a5a75a65816.dll  （参考 add.c 的插件结构） */
#include <stdint.h>
#include <stddef.h>
...
__declspec(dllexport) void run(void) {
    ...
    float s; Vector2 v;
    *B->stk_off -= 4; memcpy(&s, B->stk + *B->stk_off, 4);
    *B->stk_off -= 8; memcpy(&v, B->stk + *B->stk_off, 8);
    Vector2 r = Vector2Scale(v, s);
    push_bytes(B, &r, 8);
    B->run_next();
