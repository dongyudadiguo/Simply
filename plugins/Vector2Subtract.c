/* token="Vector2Subtract" -> sha256 -> 27a7c6b55690251a23a9b73acd08b1a9a0cb362c6a96f851edee15d10499c917.dll  （参考 add.c 的插件结构） */
#include <stdint.h>
#include <stddef.h>
...
__declspec(dllexport) void run(void) {
    ...
    Vector2 b, a;
    *B->stk_off -= 8; memcpy(&b, B->stk + *B->stk_off, 8);
    *B->stk_off -= 8; memcpy(&a, B->stk + *B->stk_off, 8);
