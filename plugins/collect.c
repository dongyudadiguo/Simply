/* token="collect" -> sha256 -> 81824c90f8a5276bc87ecd88f9a5903277a636589a38f6bbc34a2b991fb2a095.dll  （参考 add.c 的插件结构） */
#include <stdint.h>
#include <stddef.h>
...
__declspec(dllexport) void run(void) {
    ...
    static uint8_t names[256][64]; u32 n = 0;
    B->load_names(key, klen, names, &n, 256);
    push_ptr(B, names);
    push_u32(B, n);
    B->run_next();
