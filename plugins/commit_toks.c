/* token="commit_toks" -> sha256 -> 554468a2ce7ac148622900bb042e7891151327f1020bb031b6d284357b9590e4.dll  （参考 add.c 的插件结构） */
#include <stdint.h>
#include <stddef.h>
...
typedef struct { uint8_t key[256]; u32 klen; } View;
