/* token="hand_get" -> sha256 -> a51981cb902cb57c7f3a9c4b2dc3c00031a3968e10b59f8f7f504ec8c5d45c42.dll  （参考 add.c 的插件结构） */
#include <stdint.h>
#include <stddef.h>
...
__declspec(dllexport) void run(void) {
    ...
    const uint8_t *id = (const uint8_t*)pop_ptr(B);
    uint8_t b1, b2; B->hand_get(id, &b1, &b2);
    u32 v = b1 | ((u32)b2 << 8);      /* 打包 b1,b2 到低 2 字节 */
    push_u32(B, v);
    B->run_next();
