/* token="hand_set" -> sha256 -> 579a74ae71e2eb063e7d4ed058bb97ec65cb505b4331bb0a7fa4b5bb40796e7c.dll  （参考 add.c 的插件结构） */
#include <stdint.h>
#include <stddef.h>
...
__declspec(dllexport) void run(void) {
    ...
    uint8_t b2 = (uint8_t)pop_u32(B);
    uint8_t b1 = (uint8_t)pop_u32(B);
