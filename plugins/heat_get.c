/* token="heat_get" -> sha256 -> 30a75f0dd073786d9a088d507ae4fb0e7b7362ae73701a539bb155258370988c.dll  （参考 add.c 的插件结构） */
#include <stdint.h>
#include <stddef.h>
...
__declspec(dllexport) void run(void) {
    ...
    u32 nlen = pop_u32(B);
    const uint8_t *name = (const uint8_t*)pop_ptr(B);
    push_u32(B, B->heat_get(name, nlen));
    B->run_next();
