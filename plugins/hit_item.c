/* token="hit_item" -> sha256 -> 5bc8c2c4f072bddec4f1c53cde8807f9b4e3be6b852b953f1b6c5f3aed48f488.dll  （参考 add.c 的插件结构） */
#include <stdint.h>
#include <stddef.h>
...
__declspec(dllexport) void run(void) {
    ...
    { float _x; *B->stk_off -= 4; memcpy(&_x, B->stk + *B->stk_off, 4); (void)_x; }
    { float _x; *B->stk_off -= 4; memcpy(&_x, B->stk + *B->stk_off, 4); (void)_x; }
    pop_u32(B);
    /* 占位：依赖编辑器全局状态，返回 -1 */
    push_u32(B, (u32)-1);
