/* token="item_color" -> sha256 -> 1f19327df09e27947b9453ae9369cca688f85a0a33ccedb835adc134db202f9b.dll  （参考 add.c 的插件结构） */
#include <stdint.h>
#include <stddef.h>
...
static Color item_color_impl(BlockAPI *B, const Tok *t) {
    ...
    return hp_impl(t->name, t->nlen) ? C_HIT : C_DIM;
}
