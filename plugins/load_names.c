/* token="load_names" -> sha256 -> e322eab4abd3f0e54c3863160dd6e35ba58183f2931e10232a9201defbee0cd1.dll  （参考 add.c 的插件结构） */
#include <stdint.h>
#include <stddef.h>
...
__declspec(dllexport) void run(void) {
    ...
    static uint8_t names[256][64];
    u32 n = 0;
    B->load_names(key, klen, names, &n, maxn > 256 ? 256 : maxn);
    push_ptr(B, names);
    push_u32(B, n);
    B->run_next();
