/* token="memcmp" -> sha256 -> 2e3b2923d6e3106decc7b419bb355a7f620c3ec8377e5959fe23a9d6758a00e3.dll  （参考 add.c 的插件结构） */
#include <stdint.h>
#include <stddef.h>
...
__declspec(dllexport) void run(void) {
    ...
    u32 n = pop_u32(B);
    const void *s2 = (const void*)pop_ptr(B);
    const void *s1 = (const void*)pop_ptr(B);
    push_u32(B, (u32)memcmp(s1, s2, n));
    B->run_next();
