/* token="memcpy" -> sha256 -> aa517fa41db4b3dde1f67d375307d19a8a3672dc82d8f3da393b1a5c46c054b6.dll  （参考 add.c 的插件结构） */
#include <stdint.h>
#include <stddef.h>
...
__declspec(dllexport) void run(void) {
    ...
    u32 n = pop_u32(B);
    void *src = (void*)pop_ptr(B);
    void *dst = (void*)pop_ptr(B);
    push_ptr(B, memcpy(dst, src, n));
    B->run_next();
