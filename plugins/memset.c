/* token="memset" -> sha256 -> 0b96f786b0eabccfa39f2ef28ff326eaaeb6fd952729dc90a39d4955fa9858c0.dll  （参考 add.c 的插件结构） */
#include <stdint.h>
#include <stddef.h>
...
__declspec(dllexport) void run(void) {
    ...
    u32 val = pop_u32(B);
    u32 n = pop_u32(B);
    void *p = (void*)pop_ptr(B);
    push_ptr(B, memset(p, (int)val, n));
    B->run_next();
