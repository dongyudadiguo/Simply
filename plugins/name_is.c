/* token="name_is" -> sha256 -> 3783223afb061d745b3ae00f220557c6e929d6d90e4c8fc7ff0abcd795903e08.dll  （参考 add.c 的插件结构） */
#include <stdint.h>
#include <stddef.h>
...
__declspec(dllexport) void run(void) {
    ...
    const char *s = (const char*)pop_ptr(B);
    Tok *t = (Tok*)pop_ptr(B);
    size_t n = strlen(s);
    u32 r = (t->nlen == n && memcmp(t->name, s, n) == 0) ? 1 : 0;
    push_u32(B, r);
    B->run_next();
