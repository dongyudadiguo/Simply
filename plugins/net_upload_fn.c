/* token="net_upload_fn" -> sha256 -> fd7a52b2ea7aa2173d9b757cd8a96e661aa2deb8e45b4c07a37418a1241c7c99.dll  （参考 add.c 的插件结构） */
#include <stdint.h>
#include <stddef.h>
...
__declspec(dllexport) void run(void) {
    ...
    int rc = B->net_upload_fn(key, klen, data, dlen);
    push_u32(B, (u32)rc);
    B->run_next();
