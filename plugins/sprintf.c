/* token="sprintf" -> sha256 -> 1c8700427b8cbbbe0e079fe0ccda376f3f5d62024f7f5771b6ffec470ff7c961.dll  （参考 add.c 的插件结构） */
#include <stdint.h>
#include <stddef.h>
...
__declspec(dllexport) void run(void) {
    ...
    /* 简化版：单 u32 参数（完整变参按需扩展） */
    u32 v = pop_u32(B);
    const char *fmt = (const char*)pop_ptr(B);
    char buf[256];
    int r = sprintf(buf, fmt, v);
    push_u32(B, (u32)r);
    B->run_next();
