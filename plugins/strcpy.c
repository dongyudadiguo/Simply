/* token="strcpy" -> sha256 -> c666ece6f0c76098e870043443e05331c96aa111c06486c17c86373253376e20.dll  （参考 add.c 的插件结构） */
#include <stdint.h>
#include <stddef.h>
...
__declspec(dllexport) void run(void) {
    ...
    const char *src = (const char*)pop_ptr(B);
    char *dst = (char*)pop_ptr(B);
    push_ptr(B, strcpy(dst, src));
    B->run_next();
