/* token="strncmp" -> sha256 -> 656cd22a7ebe109cf6bd2ab4cdd69e20cafaf33a69b03461c78496cd0f10520a.dll  （参考 add.c 的插件结构） */
#include <stdint.h>
#include <stddef.h>
...
__declspec(dllexport) void run(void) {
    ...
    u32 n = pop_u32(B);
    const char *s2 = (const char*)pop_ptr(B);
    const char *s1 = (const char*)pop_ptr(B);
    push_u32(B, (u32)strncmp(s1, s2, n));
    B->run_next();
